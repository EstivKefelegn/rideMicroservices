...
type PreviewTripRequest struct {
	...
	StartLication *Coordinate            `protobuf:"bytes,2,opt,name=startLication,proto3" json:"startLication,omitempty"`
...
func (x *PreviewTripRequest) GetStartLication() *Coordinate {
	if x != nil {
		return x.StartLication
	}
	return nil
}
...
type Coordinate struct {
	...
	Longtude      float64                `protobuf:"fixed64,2,opt,name=longtude,proto3" json:"longtude,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *Coordinate) GetLattitude() float64 {
	if x != nil {
		return x.Lattitude
	}
	return 0
...
func (x *Coordinate) GetLongtude() float64 {
	if x != nil {
		return x.Longtude
	}
	return 0
...
const file_trip_proto_rawDesc = "" +
	...
	"\rstartLication\x18\x02 \x01(\v2\x10.trip.CoordinateR\rstartLication\x122\n" +
	...
	"\trideFares\x18\x03 \x03(\v2\x0f.trip.RideShareR\trideFares\"k\n" +
	"\x05Route\x12*\n" +
	...
	"\n" +
	"Coordinate\x12\x1c\n" +
	"\tlattitude\x18\x01 \x01(\x01R\tlattitude\x12\x1a\n" +
	"\blongtude\x18\x02 \x01(\x01R\blongtude2Q\n" +
	"\vTripService\x12B\n" +
...
var file_trip_proto_depIdxs = []int32{
	5, // 0: trip.PreviewTripRequest.startLication:type_name -> trip.Coordinate
	...
	5, // 5: trip.Geometry.coordinate:type_name -> trip.Coordinate
